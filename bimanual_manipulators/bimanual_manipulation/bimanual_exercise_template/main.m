...
minimum_altitude_l = minimum_altitude_task("L", "LT", threshold_altitude);
minimum_altitude_r = minimum_altitude_task("R", "RT", threshold_altitude);

% joint limits
joint_limits_l = joint_limits_task("L", "LT");
joint_limits_r = joint_limits_task("R", "RT");

% Coop motion phase
coop_task = rigid_grasp_task(arm1, arm2);
